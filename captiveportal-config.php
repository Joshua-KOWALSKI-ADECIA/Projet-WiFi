...
$welcomeMessage_string = "L'équipe de $hotelName est heureuse de vous offrir la connexion internet.<br/></br>Vous n'êtes plus qu'à quelques clics d'un accès web au sein de notre entreprise.";

// UI field strings
$roomNumber_string = "Numéro";
$confirmationCode_string = "Code d'accès";
...
$confirmationCodeValidation_string = "Merci de renseigner le code d'accès internet";
$emailAddressValidation_string = "Renseignez une adresse email valide.";
$familyNameValidation_string = "Entrez votre nom.";
$surNameValidation_string = "Entrez votre prénom.";
...
$incorrectConfirmationCode_string = "Le code d'accès ne semble pas correct.";
